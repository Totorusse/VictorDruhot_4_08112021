        ...
        e && e.preventDefault(),
          ...
          e.isDefaultPrevented() ||
            ...
            t.support.transition && a.hasClass("fade")
              ? a.one("bsTransitionEnd", o).emulateTransitionEnd(i.TRANSITION_DURATION)
              : o());
      });
    var o = t.fn.alert;
      ...
      (e.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          t.support.transition && this.$tip.hasClass("fade")
            ? s.one("bsTransitionEnd", m).emulateTransitionEnd(e.TRANSITION_DURATION)
            : m();
        }
      }),
          ...
          a.isDefaultPrevented()
            ...
            : (s.removeClass("in"),
              t.support.transition && s.hasClass("fade")
                ? s.one("bsTransitionEnd", o).emulateTransitionEnd(e.TRANSITION_DURATION)
                : o(),
              (this.hoverState = null),
              this)
        );
