            ...
            this.each(function () {
              ...
              if (
                (!l.length &&
                  ...
                  ((l = a('<div class="help-block" />')), o.append(l), e.push(l[0])),
                r.options.sniffHtml)
              ) {
                var c = "";
                if (
                  ...
                  (c =
                    "Too high: Maximum of '" + v + "'\x3c!-- data-validation-max-message to override --\x3e"),
                ...
                if (void 0 !== t.attr("min") || void 0 !== t.attr("aria-valuemin")) {
                  ...
                  (c =
                    "Too low: Minimum of '" + m + "'\x3c!-- data-validation-min-message to override --\x3e"),
              ...
              a.each(d, function (e, n) {
                  ...
                  a.each(r.validatorTypes, function (e, r) {
                    void 0 === h[e] && (h[e] = []),
                      s ||
                        ...
                        (h[e].push(a.extend(!0, { name: i(r.name), message: o }, r.init(t, n))), (s = !0));
                  }),
                ...
                t.data(
                  ...
                  t.data("original-aria-invalid") ? t.data("original-aria-invalid") : t.attr("aria-invalid")
                ),
                      ...
                      (c = a.unique(c.sort())).length
                        ? (o.removeClass("success error").addClass("warning"),
                          r.options.semanticallyStrict && 1 === c.length
                            ? l.html(
                                c[0] + (r.options.prependExistingHelpBlock ? l.data("original-contents") : "")
                              )
                            : l.html(
                                '<ul class="list-unstyled alert alert-warning" role="alert"><li>' +
                                  c.join("</li><li>") +
                                  "</li></ul>" +
                                  (r.options.prependExistingHelpBlock ? l.data("original-contents") : "")
                              ))
